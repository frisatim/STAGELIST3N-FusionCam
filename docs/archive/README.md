# Archive - notes de travail du stage
...
depot (par exemple d'anciens noms de scripts). Pour l'etat final du
projet, se referer aux documents de `docs/` et au README racine.

Les adresses IP internes du laboratoire ont ete remplacees par des
placeholders (`<CAMERA_NET>`, `<GATEWAY_IP>`, `<SERVER_IP>`).
